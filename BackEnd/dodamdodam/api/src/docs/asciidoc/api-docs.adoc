...
==== fail (이미 사용중인 아이디)
CURL:
include::{snippets}/user-controller-test/id-check_이미사용중인_아이디/curl-request.adoc[]
Request Parameters:
include::{snippets}/user-controller-test/id-check_이미사용중인_아이디/httpie-request.adoc[]
include::{snippets}/user-controller-test/id-check_이미사용중인_아이디/http-request.adoc[]
Request HTTP Example:
include::{snippets}/user-controller-test/id-check_이미사용중인_아이디/request-body.adoc[]
Response Fields:
include::{snippets}/user-controller-test/id-check_이미사용중인_아이디/http-response.adoc[]
Response HTTP Example:
include::{snippets}/user-controller-test/id-check_이미사용중인_아이디/response-body.adoc[]
