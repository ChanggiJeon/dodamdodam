...
class WishtreeRepositoryImpl(
    ...
    override suspend fun getWishTree(): Resource<WishtreeRes> =
    ...
    override suspend fun createWishTree(content: String): Resource<BaseResponse> =
        withContext(ioDispatcher) {
            try {
    ...
    override suspend fun updateWishTree(wishTreeId: Int, content: String): Resource<BaseResponse> =
        withContext(ioDispatcher) {
            try {
                val wishTreeReq = WishTreeReq(content = content)
    ...
    override suspend fun deleteWishTree(wishTreeId: Int): Resource<BaseResponse> =
        withContext(ioDispatcher){
            try {
